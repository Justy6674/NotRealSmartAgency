---
description: "YC Office Hours — two modes. Startup mode: six forcing questions that expose demand reality, status quo, desperate specificity, narrowest wedge, observation, and future-fit. Builder mode: design thinking brainstorming for side projects, hackathons, learning, and open source. Saves a design doc."
---
...
Invoke the **`office-hours`** skill with the Skill tool, passing anything the
...
---
Wrapper only. The skill itself lives at `~/.claude/skills/gstack/office-hours/SKILL.md`
