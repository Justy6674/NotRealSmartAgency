      ...
      <div className="flex h-full flex-col" style={{ fontFamily: '"IBM Plex Sans", sans-serif', background: 'oklch(0.06 0 0)' }}>
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div
            ...
            style={{
              ...
              background: displayUrl
                ...
                : 'linear-gradient(135deg, oklch(0.12 0.01 25), oklch(0.08 0.005 0))',
              display: 'flex',
              alignItems: 'center',
          ...
          >
            ...
            >
              <Bookmark className="h-3 w-3" style={{ color: 'oklch(1 0 0)' }} />
              <span style={{ fontSize: 11, fontWeight: 700, color: 'oklch(1 0 0)' }}>Save</span>
            </div>
            {/* More + link overlay */}
            <div
              style={{
            ...
            >
              ...
              >
                <ExternalLink className="h-3 w-3" style={{ color: 'oklch(1 0 0)' }} />
              </div>
              <div
                style={{
                  width: 28,
              ...
              >
                <MoreHorizontal className="h-3 w-3" style={{ color: 'oklch(1 0 0)' }} />
              </div>
            </div>
          </div>
          ...
          <div className="px-3 py-2.5">
            {/* Title / caption */}
            <p style={{ fontSize: 13, fontWeight: 600, color: 'oklch(0.9 0 240)', lineHeight: 1.4 }}>
              ...
              <div
                ...
                style={{
                  ...
                  background: brandAvatarUrl
                    ...
                    : 'linear-gradient(135deg, oklch(0.45 0.18 25), oklch(0.55 0.15 350))',
                }}
              />
              <span style={{ fontSize: 11, fontWeight: 600, color: 'oklch(0.7 0 240)' }}>
                {brandName}
              </span>
            </div>
          </div>
