...
export function ThreadsMockup({
  ...
  return (
    <PhoneFrame aspect={aspect}>
      <div className="flex h-full flex-col" style={{ fontFamily: '"IBM Plex Sans", sans-serif', background: 'oklch(0.04 0 0)' }}>
        {/* Threads nav bar */}
        ...
        {/* Post */}
        <div className="flex gap-2.5 px-3 py-3" style={{ borderBottom: '1px solid oklch(0.15 0.005 240)' }}>
          {/* Avatar + thread line */}
            ...
            <div
              ...
              style={{
                ...
                background: brandAvatarUrl
                  ...
                  : 'linear-gradient(135deg, oklch(0.3 0 0), oklch(0.5 0 0))',
              }}
            />
            <div
              className="flex-1"
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                <span style={{ fontSize: 12, fontWeight: 700, color: 'oklch(0.95 0 0)' }}>{handle}</span>
                <span style={{ fontSize: 11, color: 'oklch(0.4 0 0)' }}>now</span>
              </div>
              <span style={{ fontSize: 14, color: 'oklch(0.4 0 0)' }}>...</span>
            </div>

            {/* Post text */}
            <p style={{ fontSize: 12, color: 'oklch(0.9 0 0)', lineHeight: 1.5, marginTop: 3 }}>
            ...
            {/* Engagement text */}
            <div className="mt-1.5" style={{ fontSize: 10, color: 'oklch(0.4 0 0)' }}>
              0 replies · 0 likes
            </div>
          </div>
        </div>
