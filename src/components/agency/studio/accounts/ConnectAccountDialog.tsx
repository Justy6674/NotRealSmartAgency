 ...
 *
 * Phase 9 of the Mixpost UI port — during the transition, NRS still
 * uses Mixpost's OAuth flows for social connections (Phase 10 will
 * replace this with direct platform OAuth living inside NRS).
 */
...
export function ConnectAccountDialog({ onClose, onRefresh }: ConnectAccountDialogProps) {
  ...
  const accountsUrl = workspaceUuid
    ? `${webBase}/${workspaceUuid}/accounts`
    : `${webBase}/accounts`
